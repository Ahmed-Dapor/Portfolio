    ...
    return (
        <section className="w-full py-20">
            <h1 className="heading">
                My <span className="text-purple">approash</span>
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card
                    ...
                    description="We'll collaborate to map out your website's goals, target audience, and key functionalities. we'll discus things like site structure, navigation,and content requirment."
                    >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    ...
                    description="This is where the magice happens! Based on the approved design , I'll translate everything into functional code , building your website from the ground up"
                    >
